      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-[#00ff0030]">
            <th className="py-3 px-4 text-left text-sm text-gray-300">Title</th>
            <th className="py-3 px-4 text-left text-sm text-gray-300">Status</th>
            <th className="py-3 px-4 text-left text-sm text-gray-300">Category</th>
            <th className="py-3 px-4 text-left text-sm text-gray-300">Date</th>
        ...
        <tbody>
          {allTasks.map((task) => (
            <tr 
              key={task.taskNumber}
              className="border-b border-[#00ff0030] hover:bg-black/30 transition-colors"
            >
              ...
              <td className="py-4 px-4 text-[#00ff00]">{task.category}</td>
              <td className="py-4 px-4 text-gray-400">{task.date}</td>
              <td className="py-4 px-4">
                <div>
                  <p className="text-white">{task.employeeName}</p>
  ...
  const CardView = () => (
    <div className="md:hidden space-y-4">
      {allTasks.map((task) => (
        <div
          key={task.taskNumber}
          className="p-4 bg-black/50 border border-[#00ff0030] rounded-lg space-y-3"
        >
          ...
          <div className="pt-2 border-t border-[#00ff0030]">
